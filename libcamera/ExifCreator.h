...
public:
    ...
    void __ExifWriteGPSInfoTag(unsigned short tagID, Rational* pValue, unsigned int count, 
				unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset);
    void __ExifWriteRATIONALTag(unsigned short tagID, unsigned int numerator, unsigned int denominator,
				unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset);
    void __ExifWriteSRATIONALTag(unsigned short tagID, int numerator, int denominator, 
				unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset);
    void __ExifWriteLONGTag(unsigned short tagID, unsigned int value, unsigned char* pInput, 
				unsigned char* pCurBuff);
    void __ExifWriteSHORTTag(unsigned short tagID, unsigned short value, unsigned char* pInput,
				unsigned char* pCurBuff );
    void __ExifWriteBYTESTag(unsigned short tagID, unsigned char *pValue, unsigned int count,
				unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset);
    void __ExifWriteASCIITag(unsigned short tagID, unsigned char* pString, unsigned int count,
				unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset);
    void __ExifWriteUNDEFINEDTag(unsigned short tagID, unsigned char* pValue, unsigned int count,
				unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset);
    void __ExifWriteIFDTag(unsigned short tagID, ExifInfoStructure *pSetExifInfo, unsigned char* pInput,
    ...
    void __ExifWriteExifIFD(ExifInfoStructure *pSetExifInfo, unsigned char* pInput, unsigned char* pCurBuff,
				unsigned int *pOffset);
    void __ExifWriteGPDIFD(ExifInfoStructure *pSetExifInfo, unsigned char* pInput, unsigned char* pCurBuff,
				unsigned int *pOffset);
