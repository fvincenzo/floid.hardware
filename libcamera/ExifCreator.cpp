...
unsigned int ExifCreator::__ExifCreate(unsigned char* pInput, ExifInfoStructure *pSetExifInfo)
{
    ...
    *pCurBuff++ = 0x49;
	...
	if(offset + pSetExifInfo->thumbSize < 0xffff) {
	    LOGD("Exif thumnail writing from buffer %p with size %d", pSetExifInfo->thumbStream, pSetExifInfo->thumbSize);
...
void ExifCreator::__ExifWriteIFDTag(unsigned short tagID, ExifInfoStructure *pSetExifInfo,
				    unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset)
{
    //Exif IFD pointer
...
void ExifCreator::__ExifWriteGPDIFD(ExifInfoStructure *pSetExifInfo, unsigned char* pInput,
				    unsigned char* pCurBuff, unsigned int *pOffset)
{
    unsigned int count = 0;
...
void ExifCreator::__ExifWriteExifIFD(ExifInfoStructure *pSetExifInfo, unsigned char* pInput,
				     unsigned char* pCurBuff, unsigned int *pOffset)
{
    unsigned int count = 0;
...
void ExifCreator::__ExifWriteGPSInfoTag(unsigned short tagID, Rational* pValue, unsigned int count,
					unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset)
{
...
void ExifCreator::__ExifWriteRATIONALTag(unsigned short tagID, unsigned int numerator, unsigned int denominator,
					 unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset)
{
    __ExifWriteSHORT_LE(pCurBuff, tagID);//tag
    pCurBuff +=2;
...
void ExifCreator::__ExifWriteSRATIONALTag(unsigned short tagID, int numerator, int denominator, unsigned char* pInput,
					  unsigned char* pCurBuff, unsigned int *pOffset)
{
    __ExifWriteSHORT_LE(pCurBuff, tagID);//tag
    pCurBuff +=2;
...
void ExifCreator::__ExifWriteLONGTag(unsigned short tagID, unsigned int value, unsigned char* pInput,
...
void ExifCreator::__ExifWriteSHORTTag(unsigned short tagID, unsigned short value, unsigned char* pInput,
				      unsigned char* pCurBuff )
{
    __ExifWriteSHORT_LE(pCurBuff, tagID);//tag
    pCurBuff +=2;
...
void ExifCreator::__ExifWriteBYTESTag(unsigned short tagID, unsigned char *pValue, unsigned int count, unsigned char* pInput,
				      unsigned char* pCurBuff, unsigned int *pOffset)
{
    __ExifWriteSHORT_LE(pCurBuff, tagID);//tag
    pCurBuff +=2;
...
void ExifCreator::__ExifWriteASCIITag(unsigned short tagID, unsigned char* pString, unsigned int count, unsigned char* pInput,
				      unsigned char* pCurBuff, unsigned int *pOffset)
{
    __ExifWriteSHORT_LE(pCurBuff, tagID);//tag
    pCurBuff +=2;
...
void ExifCreator::__ExifWriteUNDEFINEDTag(unsigned short tagID, unsigned char* pValue, unsigned int count, unsigned char* pInput,
					  unsigned char* pCurBuff, unsigned int *pOffset)
{
    __ExifWriteSHORT_LE(pCurBuff, tagID);//tag
    pCurBuff +=2;
