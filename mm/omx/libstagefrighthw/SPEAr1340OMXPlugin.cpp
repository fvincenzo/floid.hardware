...
namespace android
{
    ...
    OMX_ERRORTYPE SPEAr1340OMXPlugin::makeComponentInstance (const char *name,
    ...
    OMX_ERRORTYPE SPEAr1340OMXPlugin::destroyComponentInstance (OMX_COMPONENTTYPE *component)
    {
        if (mLibHandle == NULL) {
            return OMX_ErrorUndefined;
        }
    ...
    OMX_ERRORTYPE SPEAr1340OMXPlugin::enumerateComponents (OMX_STRING name, size_t size, OMX_U32 index)
    {
        if (mLibHandle == NULL) {
            return OMX_ErrorUndefined;
        }
    ...
    OMX_ERRORTYPE SPEAr1340OMXPlugin::getRolesOfComponent (const char *name, Vector < String8 > *roles)
    {
        roles->clear ();
