...
char *tComponentName[MAXCOMP][2] = {
	...
	{"OMX.hantro.G1.video.decoder", "video_decoder.mpeg2"},
...
OMX_ERRORTYPE hantro_OMX_Init()
{
    ...
    LOGD(("OMX core: hantro_OMX_Init... done\n"));
    return eError;
}
/******************************Public*Routine******************************\
* OMX_GetHandle
    ...
    OMX_PTR pAppData, OMX_CALLBACKTYPE* pCallBacks)
{
    ...
    LOGD("OMX core: hantro_OMX_GetHandle...\n");
    LOGD("OMX core: component name: %s\n", cComponentName);
...
UNLOCK_MUTEX:
    ...
    LOGD(("OMX core: hantro_OMX_GetHandle... done\n"));
    return (err);
}
...
OMX_ERRORTYPE hantro_OMX_FreeHandle (OMX_HANDLETYPE hComponent)
{
    ...
    LOGD("OMX core: hantro_OMX_FreeHandle...\n");
...
EXIT:
    ...
    LOGD("OMX core: hantro_OMX_FreeHandle... done\n");
    return retVal;
}
